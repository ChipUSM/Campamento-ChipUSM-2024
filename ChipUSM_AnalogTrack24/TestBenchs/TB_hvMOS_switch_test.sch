...
C {lab_pin.sym} 120 20 0 0 {name=p8 sig_type=std_logic lab=Vg_M2}
C {lab_pin.sym} 370 -110 0 0 {name=p1 sig_type=std_logic lab=Vg_M1}
...
C {ammeter.sym} 170 20 3 0 {name=V_IgM1 savecurrent=true spice_ignore=0}
C {ammeter.sym} 400 -110 3 0 {name=V_IgM2 savecurrent=true spice_ignore=0}
C {code.sym} -340 -260 0 0 {name=POWER_MOS_Parameters only_toplevel=false spice_ignore=false
...
"}
C {code.sym} 640 -70 0 0 {name=POWER_MOS_Parameters_Sol only_toplevel=false spice_ignore=true

...
N 2900 -990 2900 -930 {
lab=#net3}
N 2370 -865 2370 -845 { lab=GND}
N 2370 -975 2370 -925 { lab=VVSEL_VCO}
...
C {devices/vsource.sym} 2565 -910 0 0 {name=V1 value="pulse 0.6 0.9 20u 1u 1u 75u 150u"}
...
C {../top/top_CL_vto5p1.sym} 2035 -340 0 0 {name=x8}
...
C {isource.sym} 2900 -900 0 0 {name=I0 value="pulse 0.5 0.5 20u 0.5u 0.5u 25u 50u"}
...
C {devices/vsource.sym} 2370 -895 0 0 {name=VVSEL_VCO value=3.3}
C {devices/gnd.sym} 2370 -845 0 0 {name=l10 lab=GND}
C {devices/lab_wire.sym} 2370 -975 0 0 {name=l11 sig_type=std_logic lab=VVSEL_VCO}

...
df=pd.read_fwf('../sim_data/data_TDBuckTOP_vto5p2.txt',infer_nrows = 1000)
df.to_csv('../sim_data/data_TDBuckTOP_vto5p2.csv', index=False)
data = pd.read_csv("../sim_data/data_TDBuckTOP_vto5p2.csv").values

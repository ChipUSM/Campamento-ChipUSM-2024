...
df=pd.read_fwf('../sim_data/data_TDBuckTOP_vto4p2.txt',infer_nrows = 1000)
df.to_csv('../sim_data/data_TDBuckTOP_vto4p2.csv', index=False)
data = pd.read_csv("../sim_data/data_TDBuckTOP_vto4p2.csv").values
...
peaks , _ = find_peaks(y_ih, height=1.4, distance = 1000)
pk_len = len(peaks)

...
df=pd.read_fwf('../sim_data/data_VCO_vto3p1.txt')
df.to_csv('../sim_data/data_VCO_vto3p1.csv', index=False)
data = pd.read_csv("../sim_data/data_VCO_vto3p1.csv").values
